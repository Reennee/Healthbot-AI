      ...
      <div ref={containerRef} className="chat-container chat-container-scroll p-4 space-y-3 flex-grow bg-gray-50">
          ...
          <div key={m.id} className={m.role === "user" ? "flex justify-end" : "flex justify-start"}>
            <div className={m.role === "user" ? "message-bubble bg-indigo-500 text-white p-3 shadow-md max-w-[80%] rounded-[1rem]" : "message-bubble bg-white text-black p-3 shadow-md max-w-[80%] rounded-[1rem]"}>
              ...
              <div className="flex items-center justify-between mt-1">
                <p className={m.role === "user" ? "text-xs text-indigo-100" : "text-xs text-gray-500"}>{m.timestamp}</p>
                {m.role === "bot" && m.quality_metrics && (
                  <div className="flex items-center space-x-2 text-xs">
                    {m.quality_metrics.has_disclaimer && (
                      <span className="bg-green-100 text-green-800 px-2 py-1 rounded-full">Medical Disclaimer</span>
                    )}
        ...
        {isTyping && (
          <div className="flex justify-start">
            <div className="message-bubble bg-white  p-3 shadow-md max-w-[80%] rounded-2xl">
      ...
      <div className="border-t border-gray-200 p-4 bg-white text-black">
        <div className="flex space-x-2">
          <input
            ...
            className="grow border border-gray-300 rounded-full px-4 py-2 focus:outline-none focus:ring-2 focus:ring-indigo-500"
            value={input}
        ...
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
          <div className="bg-white rounded-lg p-6 max-w-2xl w-full mx-4 max-h-[80vh] overflow-y-auto">
            <div className="flex justify-between items-center mb-4">
              <h3 className="text-lg font-bold">Model Performance Metrics</h3>
              <button
            ...
            <div className="space-y-4">
              ...
              <div className="bg-purple-50 p-4 rounded-lg">
                <h4 className="font-semibold mb-2">Conversation Statistics</h4>
                <div className="grid grid-cols-2 gap-4 text-sm">
                  <div>
